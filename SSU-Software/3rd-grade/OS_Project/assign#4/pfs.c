...
path2 = strdup (path); //allocate path2 for get path
name = basename (path2); // get basename of path2
get_proc(name, &pid,proc_path, strlen(proc_path));//get pid
kill(pid, SIGKILL); // send siganl
return 0;
}
